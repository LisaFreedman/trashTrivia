$(document).ready(function() {
    ...
    var responseArray = []
        ...
        var answerArray = ["Both", "Municipal", "Federal", "Depends", "Provincial", "Depends", "The conveyer line is black and the optical reader can't distinguish between colours", "Federal", "27%", "Either"]
